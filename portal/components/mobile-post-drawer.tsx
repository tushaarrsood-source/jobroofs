      ...
      <div className="relative z-10 rounded-t-2xl border-t border-slate-200 bg-white p-5 text-slate-900 shadow-2xl animate-in slide-in-from-bottom duration-200">
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link
            href="/post-a-job"
            onClick={onClose}
            className="group flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50/60 p-4 transition-all hover:border-blue-300 hover:bg-blue-50/30 active:scale-[0.99]"
          >
            ...
            <ChevronRight className="size-4 text-slate-400 group-hover:text-blue-600 shrink-0" />
          </Link>
          ...
          <Link
            href="/wohnen/list"
            onClick={onClose}
            className="group flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50/60 p-4 transition-all hover:border-emerald-300 hover:bg-emerald-50/30 active:scale-[0.99]"
          >
            <div className="flex items-start gap-3">
