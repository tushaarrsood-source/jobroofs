...
import { ArrowRight, MapPin, Euro, Clock3, Clock } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Teilzeitjobs in Deutschland — Flexible Arbeitszeiten | JOBROOFS',
  description:
    'Finde planbare Teilzeitstellen (15–30 Std./Woche) in Berlin, München, Hamburg und bundesweit. Transparente Bezahlung und direkte Bewerbung.',
  openGraph: {
    title: 'Teilzeitjobs in Deutschland | JOBROOFS',
    description: 'Finde flexible Teilzeitstellen mit fairer Bezahlung in deiner Region.',
    url: '/teilzeit',
  },
  alternates: {
    canonical: '/teilzeit',
...
export default async function TeilzeitHubPage() {
  const jobs = await getProgrammaticJobs('teilzeit', 'all');
  ...
  return (
    <main className="min-h-screen bg-white text-[#222222] flex flex-col justify-between">
      <BreadcrumbJsonLd
        items={[
          { name: 'JOBROOFS', href: '/' },
          { name: 'Teilzeitjobs Deutschland', href: '/teilzeit' },
        ]}
      />
      <div>
        <SiteHeader />
        ...
        <section className="border-b border-zinc-200 bg-white">
          <div className="mx-auto max-w-[1180px] px-5 py-12 md:px-10 md:py-16">
            <div className="inline-flex items-center gap-2 rounded-full bg-purple-50 px-3.5 py-1 text-sm font-semibold text-purple-900">
              <Clock className="size-3.5 text-purple-700" />
              <span>15–30 Std. / Woche · Sozialversicherungspflichtig</span>
            </div>
            <h1 className="mt-4 text-3xl font-extrabold tracking-tight text-zinc-950 sm:text-5xl md:text-6xl">
              Teilzeitjobs in ganz Deutschland
            </h1>
            <p className="mt-4 max-w-2xl text-base leading-relaxed text-zinc-600 sm:text-lg">
              Entdecke Teilzeitstellen in Cafés, Boutiquen, Kanzleien, Praxen und mittelständischen Betrieben. Faire Löhne und planbare Arbeitszeiten.
            </p>
        ...
        <section className="mx-auto max-w-[1180px] px-5 py-10 md:px-10 md:py-14">
          <div className="mb-6 flex items-center justify-between border-b border-zinc-200 pb-4">
            <div>
              <h2 className="text-2xl font-bold text-black">Aktuelle Teilzeitangebote</h2>
