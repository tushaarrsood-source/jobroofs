...
export const JOB_TIERS: Record<ListingTier, TierConfig> = {
  free: {
    tier: 'free',
    serviceType: 'job',
    labelDe: '1. Inserat Gratis (30 Tage)',
    labelEn: '1st Job Free (30 Days)',
    priceEur: 0,
    durationDays: 30,
    durationMonths: 1,
    featured: false,
    badgeDe: '🎁 Erstinserat Gratis (30 Tage)',
    badgeEn: '🎁 1st Free Job (30 Days)',
    descriptionDe: '100% kostenloses Erstinserat für 30 Tage für jedes neue Benutzerkonto.',
    descriptionEn: '100% free first job listing for 30 days for every new user account.',
    perksDe: [
      ...
      'Direkt im Hero & über der Suche platziert',
    ],
    perksEn: [
      ...
      'Directly placed in hero & above search',
    ],
    stripePriceId: '',
    stripeProductId: '',
  },
  ...
  premium: {
    tier: 'premium',
    serviceType: 'job',
    labelDe: 'Extended (60 Tage)',
    labelEn: 'Extended (60 Days)',
    priceEur: 24.99,
    durationDays: 60,
    durationMonths: 2,
    featured: true,
    badgeDe: '60 Tage aktiv',
    badgeEn: '60 days active',
    descriptionDe: 'Volle 2 Monate Laufzeit & direkte Platzierung in ganz Berlin.',
    descriptionEn: 'Full 2 months duration & direct placement across Berlin.',
    perksDe: [
      '24,99 € Einmalzahlung (kein Abo)',
      '60 Tage Laufzeit (volle 2 Monate aktiv)',
      'Direkt platziert über den Suchergebnissen',
    ...
    perksEn: [
      ...
      'Directly placed above search results',
      'Prioritized pin on interactive map',
      'Automatic reach push after 30 days',
    ],
