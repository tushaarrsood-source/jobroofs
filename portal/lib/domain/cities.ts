...
export const SUPPORTED_CITIES: CityDefinition[] = [
  ...
  },
  {
    ...
    popularDistricts: ['Kreuzviertel', 'Kaiserviertel', 'Hörde (Phönixsee)', 'Innenstadt-West'],
    description: 'Pott-Kultur, Cafés am Phönixsee, Logistik & Kiezbetriebe in Dortmund',
  },
  {
    id: 'essen',
    name: 'Essen',
    ...
    popularDistricts: ['Rüttenscheid', 'Holsterhausen', 'Südviertel', 'Stadtkern'],
    description: 'Rü-Gastronomie, Kreativquartiere & Handelsbetriebe in Essen',
  },
  {
    id: 'hannover',
    name: 'Hannover',
    ...
    popularDistricts: ['Linden-Nord', 'Nordstadt', 'List', 'Mitte'],
    description: 'Linden-Kiez, Messestadt-Events, Universitäts-Jobs & Cafés in Hannover',
  },
  {
    id: 'nuernberg',
    name: 'Nürnberg',
    ...
    popularDistricts: ['Gostenhof (GoHo)', 'St. Johannis', 'Altstadt', 'Maxfeld'],
    description: 'GoHo-Kreativszene, Traditionsunternehmen, Gastro & Tech in Nürnberg',
  },
];
